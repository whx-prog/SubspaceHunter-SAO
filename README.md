...
实践案例，通过教程的形式教学如何通过Cardinal AI开发出一款VRMMO多人在线动作游戏。 
...
开发者招聘：
团队已完成千万级Pre-Seed融资。公司目前正在高速发展期，需要一名经验成熟与优秀职业素养的AIAgent应用的前/后端开发工程师，<br>
主导或协作2C产品研发全流程。该岗位负责与算法团队合作搭建具身智能/游戏生成两种场景下应用产品的工程落地与应用开发，<br>
建立全链路Al Agent体系。目前期权池充足，根据实际工作成果与能力授予期权奖励<br>
联系王师傅：z04041015
...
- 确认可再分发的大体量二进制资源可使用unitypackage通过网盘链接的形式提交。
